...
<head>
    ...
    <title>Madagascar net shopping</title>
    ...
    <!-- nouislider -->
    <link type="text/css" rel="stylesheet" href="assets/assets/css/nouislider.min.css" />

    <!-- Font Awesome Icon -->
    <link rel="stylesheet" href="assets/assets/css/font-awesome.min.css">
    <link rel="stylesheet" href="assets/assets/css/open-iconic-bootstrap.min.css">
    ...
    <link rel="stylesheet" type="text/css" href="assets/assets/fonts/iconic/css/material-design-iconic-font.min.css">
    <link rel="stylesheet" type="text/css" href="assets/assets/css/util.css">
    ...
    <link rel="stylesheet" href="assets/assets/css/jquery.timepicker.css"> -->

    <!-- <link type="text/css" rel="stylesheet" href="assets/assets/css/all.css" /> -->
    <!-- <link type="text/css" rel="stylesheet" href="assets/assets/css/mystyle.css" /> -->
    ...
    <link type="text/css" rel="stylesheet" href="../../assets/assets/css/monstyle.css" /> -->
    <link rel="stylesheet" href="./assets/assets/css/monstyle.css">
                                    ...
                                    <div class="cart-list">
                                        <div class="product-widget">
                                            <div class="product-img">
                                                <img src="./assets/assets/img/product01.png" alt="">
                                            </div>
                                        ...
                                        <div class="product-widget">
                                            <div class="product-img">
                                                <img src="./assets/assets/img/product02.png" alt="">
                                            </div>
                                            <div class="product-body">
                                                <h3 class="product-name"><a href="#">product name goes here</a></h3>
        ...
        <div class="container">
            ...
            <div id="responsive-nav">
                ...
                <ul class="main-nav nav navbar-nav">
                    ...
                    <li><a href="{{route('app_legume')}}">Legumes</a></li>
                    <li><a href="{{route('app_veisselle')}}">Veisselles</a></li>
                    <li><a href="{{route('app_beaute')}}" class="nav-link">Beautes</a></li>
                    <li><a href="{{route('app_salon')}}">Salon</a></li>
                    <li><a href="{{route('app_contact')}}" class="nav-link">Contacts</a></li>
